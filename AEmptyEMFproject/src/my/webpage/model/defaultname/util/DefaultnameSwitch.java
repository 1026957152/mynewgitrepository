...
public class DefaultnameSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DefaultnamePackage.WEB: {
				Web web = (Web)theEObject;
				T result = caseWeb(web);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DefaultnamePackage.WEBPAGE: {
				Webpage webpage = (Webpage)theEObject;
				T result = caseWebpage(webpage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DefaultnamePackage.CATEGORY: {
				Category category = (Category)theEObject;
				T result = caseCategory(category);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DefaultnamePackage.ARICLE: {
				Aricle aricle = (Aricle)theEObject;
				T result = caseAricle(aricle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Aricle</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Aricle</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAricle(Aricle object) {
		return null;
	}
