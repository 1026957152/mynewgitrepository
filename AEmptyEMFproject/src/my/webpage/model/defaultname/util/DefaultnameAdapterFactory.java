/**
 */
package my.webpage.model.defaultname.util;
...
public class DefaultnameAdapterFactory extends AdapterFactoryImpl {
	...
	protected DefaultnameSwitch<Adapter> modelSwitch =
		new DefaultnameSwitch<Adapter>() {
			...
			@Override
			public Adapter caseAricle(Aricle object) {
				return createAricleAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link my.webpage.model.defaultname.Web <em>Web</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link my.webpage.model.defaultname.Webpage <em>Webpage</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link my.webpage.model.defaultname.Category <em>Category</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link my.webpage.model.defaultname.Aricle <em>Aricle</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAricleAdapter() {
		return null;
	}
